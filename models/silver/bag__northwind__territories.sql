MODEL (
  ...
  kind VIEW,
  grain (_hook__reference__id__territory__valid_from)
);

SELECT
  CONCAT('northwind|territory|', territory_id::TEXT, '~epoch|valid_from|', _sqlmesh_valid_from::TEXT)::BLOB AS _hook__reference__id__territory__valid_from,
  CONCAT('northwind|territory|', territory_id::TEXT)::BLOB AS _hook__reference__id__territory,
  CONCAT('northwind|region|', region_id::TEXT)::BLOB AS _hook__reference__id__region,
  territory_id,
